...
namespace Rookies_EFCoreAssignment.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Location = table.Column<string>(type: "nvarchar(max)", nullable: false, defaultValue: "Hanoi")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Departments", x => x.Id);
                    table.CheckConstraint("CK_Department_Location", "Location IN ('Hanoi', 'HCM', 'Danang')");
                });
