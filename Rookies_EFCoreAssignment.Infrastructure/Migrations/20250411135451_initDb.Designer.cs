...
namespace Rookies_EFCoreAssignment.Infrastructure.Migrations
{
    ...
    [Migration("20250411135451_initDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rookies_EFCoreAssignment.Domain.Entities.Department", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Rookies_EFCoreAssignment.Domain.Entities.Employee", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Rookies_EFCoreAssignment.Domain.Entities.Project", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Rookies_EFCoreAssignment.Domain.Entities.ProjectEmployee", b =>
                {
            ...
            modelBuilder.Entity("Rookies_EFCoreAssignment.Domain.Entities.Salary", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rookies_EFCoreAssignment.Domain.Entities.Employee", b =>
                {
                    b.HasOne("Rookies_EFCoreAssignment.Domain.Entities.Department", "Department")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("Rookies_EFCoreAssignment.Domain.Entities.ProjectEmployee", b =>
                {
                    b.HasOne("Rookies_EFCoreAssignment.Domain.Entities.Employee", "Employee")
                        .WithMany("ProjectEmployees")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Rookies_EFCoreAssignment.Domain.Entities.Project", "Project")
                        .WithMany("ProjectEmployees")
            ...
            modelBuilder.Entity("Rookies_EFCoreAssignment.Domain.Entities.Salary", b =>
                {
                    b.HasOne("Rookies_EFCoreAssignment.Domain.Entities.Employee", "Employee")
                        .WithOne("Salary")
                        .HasForeignKey("Rookies_EFCoreAssignment.Domain.Entities.Salary", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
